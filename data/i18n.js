...
window.I18N = {
  zh: {
    ...
    "home.ic1.title": "人因工程",
    "home.ic1.text":
      "例如：为什么 VR 和自动驾驶会让人晕?我用 DTI 脑网络特征预测个体的晕动症易感性,并研究成人与儿童在相关脑区上的差异。",
    "home.ic2.title": "人与技术的交互",
    "home.ic2.text":
      "如：可预测性线索 + 非驾驶任务 → 反馈——如何塑造人在 VR、车辆与机器人系统中的舒适度和表现?",
    "home.ic3.title": "面向人类研究的工程方法",
    "home.ic3.text":
      "实验需要装置。如当前的我所负责搭建心理学实验赖以运行的 VR 环境、六自由度运动平台与数据处理流程。",
    ...
    "home.phd.text":
      "如果您的实验室从事人机工效或神经人因工效研究,期待与您交流——CV、论文与完整项目档案都在一键之遥。",
    "home.phd.btn": "联系我",
    ...
    "about.p1":
      "我是深圳大学心理学院的科研助理,研究方向是晕动症:用机器学习基于 DTI 脑网络预测个体易感性,并考察自动驾驶中预测性线索与非驾驶相关任务的交互作用。日常工作横跨 EEG 实验、VR 环境开发,以及支撑各项研究的六自由度运动平台。转向心理学之前,我受了五年机械工程训练:在东莞理工学院取得工学学士学位(专业排名 1/194),随后在香港中文大学攻读硕士。",
    "about.p2":
      "",
    "about.p3":
      "关于技术的心理学研究,需要能亲手造技术的人。晕动症实验需要 VR 环境与运动平台,神经数据研究需要可复现的处理流程。我的博士目标是人因工程与人机交互方向——继续研究人在复杂系统中的反应,同时握有心理学的实验方法,和把实验所需装置亲手造出来的工程能力。",
    "about.cv.title": "完整简历",
    "about.cv.text":
